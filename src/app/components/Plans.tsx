      ...
      <div className="mt-8 overflow-x-auto">
        {plans.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h3 className="text-lg font-medium text-zinc-900 dark:text-white mb-1">No plans yet</h3>
            <p className="text-zinc-500 dark:text-zinc-400">Click &quot;Add Plan&quot; to create your first stock plan.</p>
          </div>
        ) : (
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-zinc-200 dark:border-zinc-700">
                <th className="text-left py-3 px-4 font-medium text-zinc-500 dark:text-zinc-400">Plan</th>
                <th className="text-left py-3 px-4 font-medium text-zinc-500 dark:text-zinc-400">Stock</th>
                <th className="text-left py-3 px-4 font-medium text-zinc-500 dark:text-zinc-400">Action</th>
                <th className="text-right py-3 px-4 font-medium text-zinc-500 dark:text-zinc-400">Shares</th>
                <th className="text-right py-3 px-4 font-medium text-zinc-500 dark:text-zinc-400">Target Price</th>
                <th className="text-right py-3 px-4 font-medium text-zinc-500 dark:text-zinc-400">Change</th>
                <th className="text-left py-3 px-4 font-medium text-zinc-500 dark:text-zinc-400">Deadline</th>
